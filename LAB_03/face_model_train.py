...
with h5py.File(r'/content/drive/MyDrive/Colab Notebooks/models/model2017-1_bfm_nomouth.h5', 'r') as hf:
...
for t in range(num_iters):
    ...
    if t % 10 == 0:
        ...
        imsave(f'/content/drive/MyDrive/Colab Notebooks/img/train_{t}.png',torch.pow(img.data, 1.0/2.2).cpu().numpy())